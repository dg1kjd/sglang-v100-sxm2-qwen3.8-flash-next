...
from sglang.kernels.ops.gemm.sm70_dense_gemv import supported as gemv_supported


def enabled() -> bool:
    return envs.SGLANG_SM70_QWEN_FUSIONS.get()
...
def qkvzba_supported(x, weight, tail) -> bool:
    return (
        envs.SGLANG_SM70_MTP_QKVZBA.get()
        and x.ndim == 2
