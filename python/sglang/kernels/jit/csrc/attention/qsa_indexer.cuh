...
// The vendored sgl_kernel headers now provide DTypeTrait and CHECK_HOST
// directly (type.cuh, utils.h), so only the namespace shorthands remain --
// and they resolve inside namespace sglang, not at global scope.
